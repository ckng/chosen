...
Version 2.2.1
Full source at https://github.com/ckng/chosen
Copyright (c) 2011-2024 ckng
MIT License, https://github.com/ckng/chosen/blob/master/LICENSE.md
...
(function() {
  ...
  AbstractChosen = (function() {
    class AbstractChosen {
      ...
      get_single_html() {
        return `<a class="chosen-single chosen-default" role="button" tabindex="1">
...
<div class="chosen-drop">
  ...
  <li class="search-field">
    <input class="chosen-search-input" type="text" autocomplete="off" role="combobox" placeholder="${this.default_text}" aria-expanded="false" aria-haspopup="listbox" aria-autocomplete="list" aria-label="Search" />
  </li>
</ul>
<div class="chosen-drop">
  <ul class="chosen-results" role="listbox"></ul>
  ...
  this.Chosen = (function() {
    ...
    class Chosen extends AbstractChosen {
      ...
      set_default_values() {
        ...
        // HTML Templates
        this.single_temp = new Template('<a class="chosen-single chosen-default" role="button"><span>#{default}</span><div aria-label="Show options" tabindex="1"><b aria-hidden="true"></b></div></a><div class="chosen-drop"><div class="chosen-search"><input type="text" autocomplete="off" aria-expanded="false" aria-haspopup="listbox" role="combobox" aria-autocomplete="list" /></div><ul class="chosen-results" role="listbox" aria-busy="true"></ul></div>');
      ...
      register_observers() {
        ...
        this.container.observe("focusin", (evt) => {
          return this.container_focusin(evt);
        });
        this.container.observe("focusout", (evt) => {
          return this.container_focusout(evt);
        });
        this.container.observe("chosen:blur", (evt) => {
          return this.close_field(evt);
        });
        this.container.observe("chosen:focus", (evt) => {
      ...
      container_mouseup(evt) {
        ...
        ({
          container_focusin: function(evt) {}
        });
        if (this.active_field) {
          return;
        }
        return this.container.fire('chosen:focus');
      }
      ...
      container_focusout(evt) {
        return setTimeout(() => {
          if (!this.container.contains(document.activeElement)) {
            if (this.active_field) {
              return this.container.fire('chosen:blur');
            }
          }
        });
      }
