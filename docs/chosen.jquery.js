...
<div class="chosen-drop">
  ...
  Chosen = class Chosen extends AbstractChosen {
    ...
    register_observers() {
      ...
      this.container.on('focusin.chosen', (evt) => {
        this.container_focusin(evt);
      });
      this.container.on('focusout.chosen', (evt) => {
        this.container_focusout(evt);
      });
      this.container.on('chosen:blur.chosen', (evt) => {
        this.close_field(evt);
      });
      this.container.on('chosen:focus.chosen', (evt) => {
    ...
    container_focusin(evt) {
      ...
      return this.container.trigger("chosen:focus");
    }

    container_focusout(evt) {
      return setTimeout(() => {
        if (!this.container[0].contains(document.activeElement)) {
          if (this.active_field) {
            return this.container.trigger("chosen:blur");
          }
        }
      });
    }
