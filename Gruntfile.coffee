...
Copyright (c) 2011-<%= grunt.template.today('yyyy') %> ckng
MIT License, https://github.com/ckng/chosen/blob/master/LICENSE.md
This file is generated by `grunt build`, do not edit it by hand.
*/
\n
"""
    minified_comments: "/* Chosen <%= version_tag %> | (c) 2011-<%= grunt.template.today('yyyy') %> ckng | MIT License, https://github.com/ckng/chosen/blob/master/LICENSE.md */\n"
