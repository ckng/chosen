...
The [issue tracker](https://github.com/ItsTino/chosen/issues) is the
...
1. **Use the [GitHub issue search](https://github.com/ItsTino/chosen/search?type=Issues)** &mdash; check if the issue has already been
   reported.
...
1. [Fork](http://help.github.com/fork-a-repo/) the project, clone your fork,
   ...
   git remote add upstream https://github.com/ItsTino/chosen
   ```
...
If you're interested, you can find the task in [Gruntfile.coffee](https://github.com/ItsTino/chosen/blob/master/Gruntfile.coffee).
